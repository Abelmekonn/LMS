...
courseRouter.post("/getVdoCipherOtp", user_controller_1.updateAccessToken, course_controller_1.generateVideoUrl);
courseRouter.get("/get-course/:id", course_controller_1.getSingleCourse);
courseRouter.get("/get-admin-course", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.getAllCoursesForAdmin);
courseRouter.get("/get-courses", course_controller_1.getAllCourse);
courseRouter.get("/get-course-by-user/:id", user_controller_1.updateAccessToken, auth_1.isAuthenticated, course_controller_1.getCourseByUser);
