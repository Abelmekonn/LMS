    ...
    return (
        <div className='w-full relative'>
            <div className={`${active ?
                "dark:bg-opacity-80 dark:bg-gradient-to-b bg-white dark:from-gray-900 dark:to-black fixed top-0 left-0 w-full h-[80px] z-[80] border-b dark:border-[#ffffff1c] shadow-xl transition-all duration-500"
